...
type NotificationWithAdds struct {
	...
	Addition []*gnmi.Update `protobuf:"bytes,1,rep,name=Addition,proto3" json:"Addition,omitempty"`
	Update   []*gnmi.Update `protobuf:"bytes,2,rep,name=Update,proto3" json:"Update,omitempty"`
	Delete   []*gnmi.Update `protobuf:"bytes,3,rep,name=Delete,proto3" json:"Delete,omitempty"`
}
...
func (x *NotificationWithAdds) GetUpdate() []*gnmi.Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *NotificationWithAdds) GetDelete() []*gnmi.Update {
	if x != nil {
		return x.Delete
	}
	return nil
...
var file_notification_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61,
...
var file_notification_proto_goTypes = []interface{}{
	...
	(*gnmi.Update)(nil),          // 1: gnmi.Update
}
var file_notification_proto_depIdxs = []int32{
	1, // 0: notification.NotificationWithAdds.Addition:type_name -> gnmi.Update
	1, // 1: notification.NotificationWithAdds.Update:type_name -> gnmi.Update
	1, // 2: notification.NotificationWithAdds.Delete:type_name -> gnmi.Update
